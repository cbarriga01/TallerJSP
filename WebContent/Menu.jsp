                ...
                <div class="navbar-header">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                          <ul class="nav navbar-nav">
							  <li role="presentation"><a href="FormularioActualizar.jsp">editar contacto</a></li>
							  <li role="presentation"><a href="FormularioActualizarUsuario.jsp">editar usuario</a></li>
