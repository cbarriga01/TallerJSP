...
public class Taller1MagisterInformaticaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Taller1MagisterInformatica";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Taller1MagisterInformaticaPersistentManager();
		}
